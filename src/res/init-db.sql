...
('018f3c80-8b4e-7f63-b2ed-8e91bd776703', 'ФТ-СОФТ', NULL, '7a347577-1e7c-4a9a-b6a6-b7f4e2a9d107'),
...
-- ======================================================================
--  УРОВЕНЬ 5 — ОСНОВНОЕ ПОДРАЗДЕЛЕНИЕ → НАПРАВЛЕНИЕ АНАЛИТИКИ И ДОКУМЕНТАЦИИ
-- ======================================================================

INSERT INTO teams (id, name, parent_id, leader_employee_id) VALUES
('018f3c80-8b4f-7b11-b403-e3f1a7087709', 'Направление аналитики и документации',
 '018f3c80-8b4f-7b11-b403-e3f1a7087708', '7a347577-1e7c-4a9a-b6a6-b7f4e2a9d103');
...
VALUES
    ...
    ('7a347577-1e7c-4a9a-b6a6-b7f4e2a9d107', 'Виктор', 'Сергеевич', 'Баринов', '1982-05-08', '2006-02-01', 'Москва', 'victor.barinov@udv.com', '+7 (921) 555-00-01', 'victor.dyakov', NULL, 'Строю экосистему продуктов и развиваю цифровую культуру. В свободное время увлекаюсь яхтингом.', 'ФТ-СОФТ', 'ФТ-СОФТ', '018f3c80-8b4e-7f63-b2ed-8e91bd776703', '0f5d5d50-0000-0000-0000-000000000001')
ON CONFLICT (id) DO NOTHING;
